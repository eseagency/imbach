(function() {
    ...
    var pcBootstrap = {
        ...
        resizeCanvas: function (app, canvas, wrapper) {
            canvas.style.width = '';
            canvas.style.height = '';
        ...
        reflow: function (app, canvas, wrapper) {
            this.resizeCanvas(app, canvas, wrapper);
...
(function () {
    ...
    var configure = function () {
        app.configure(CONFIG_FILENAME, function (err) {
            ...
            setTimeout(function () {
                pcBootstrap.reflow(app, canvas, wrapper);
                pcBootstrap.reflowHandler = function() { pcBootstrap.reflow(app, canvas, wrapper); };
